...
public class SendMailText_Picture_Enclosure {
    ...
    public static MimeMessage getMimeMessage(Session session) throws Exception {
        ...
        // 读取本地文件
        DataHandler dh = new DataHandler(new FileDataSource("D:\\code\\git\\study\\emailTest\\src\\mailTestPic.png"));
        // 将图片数据添加到"节点"
        ...
        // 读取本地文件
        DataHandler dh2 = new DataHandler(new FileDataSource("D:\\code\\git\\study\\emailTest\\src\\file.txt"));
        // 将附件数据添加到"节点"
